package com.patrykkosieradzki.theanimalapp.network.utils

import com.patrykkosieradzki.theanimalapp.domain.AppConfiguration
import com.patrykkosieradzki.theanimalapp.domain.exceptions.ApiException
            ...
            try {
                when (val apiResult: ApiResult<T> = block()) {
                    ...
                    is ApiResult.Failure ->
                        throw ApiException.UnknownApiException(apiResult.apiError)
